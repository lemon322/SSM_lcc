...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath}/UserManager/toUserManagerPage">
					 <span>用户名：</span>
					 ...
					 <a href="${pageContext.request.contextPath}/UserManager/toAddUserPage" >添加用户</a>
				</form>
            </div>
            <!--用户-->
